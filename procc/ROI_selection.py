...
def detect_lines(image, title='default', rho=1, theta=np.pi / 180, threshold=50, minLinLength=290, maxLineGap=6,
    ...
    if (write):
        cv.imwrite("../Images/" + title + ".jpeg", cImage)
...
def main(argv):
    default_file = '/home/ashok/PycharmProjects/CodingManiac/pro/sc.jpeg'
