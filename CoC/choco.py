...
Minimum split is 3
Input
Line 1: Space-separated integers M and N, representing the width and height of the chocolate bar.
Output
The minimum number of splits necessary to divide the bar into 1*1 units
Constraints
1 ≤ M, N ≤ 100,000
Example
Input
